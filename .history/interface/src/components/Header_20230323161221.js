              ...
              <div class="modal-body">
                ...
                <div class='d-flex flex-column'>
                  <label class="labe1">Nom du plante</label>
                    ...
                    {
                      autre && <>
                      <div  onChange={(e) => debits(e)} class="d-flex justify-content-center mt-4 gap-3">
                      <button class="md" value='debits'>même debit</button>
                      {
                        debit &&<>
                        <form>
                          <label>ijojojpj</label>
                          <input></input>
                        </form>
                        </>
                      }

                      <button class="md">débits différents</button>
                      </div>
                      </>
                    }
