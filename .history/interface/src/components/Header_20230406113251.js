...
function Header() {
  ...
  const [setChoix, setsetChoix] = useState('')
            ...
            <div class="modal-body">
              <form id='param'>
                <div class='d-flex flex-column'>
                 ...
                 {(!debit && !debitdif) ? <select onChange={(e) => autres(e.target.value)} id="swal-input1" class="swal2-input"
                 >
...
>
                  ...
                  <div class="d-flex gap-2 justify-content-center mt-5">
                    ...
                    <button type="button" onClick={()=>{parame()}} class="btn btn-success" className='butM' id="liveToastBtn">Modifier</button>
                  </div>
                </div>
              </form>
            </div>
