 ...
 */}      <div className={`modal ${open}`} tabindex="-1">
  ...
  >
                    <button id="butM"  type='submit' class="btn btn-success">Modifié
                    </button><svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
  <div>
