...
function Historiques() {
  ...
  const [items, setItems] = useState(["..."]); // définir les éléments du tableau
            ...
            <nav aria-label="Page navigation example">
              <ul className="pagination justify-content-center">
                <li className={`page-item ${active1 ? "active" : ""}`}>
                  <a className="page-link" href="#" onClick={() => handlePagination(1, items)}>
                    Prec
                  </a>
                </li>
                <li className={`page-item ${active2 ? "active" : ""}`}>
                  <a className="page-link" href="#" onClick={() => handlePagination(2, items)}>
                    Suiv
                  </a>
                </li>
              </ul>
